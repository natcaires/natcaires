...
const apiForecastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&APPID=a2b01d01e08c21f4a1ca665e02edce67'
  ...
  .then(function (jsonObject) { 
    ...
    for (let i = 0; i <towns.length; i++){
      ...
      function getEvents(townD) {
        ...
        image.setAttribute('src', 'images/fishhaven2.jpg');
